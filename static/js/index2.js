Ext.setup({
	...
	onReady: function() {
		...
		var position = new google.maps.LatLng(39.9529, -75.1602), //Philly
		curRoute = 33,

		//Tracking Marker Image
		image = new google.maps.MarkerImage('/jslib/touch/map/point.png', new google.maps.Size(32, 31), new google.maps.Point(0, 0), new google.maps.Point(16, 31)),
		shadow = new google.maps.MarkerImage('/jslib/touch/map/shadow.png', new google.maps.Size(64, 52), new google.maps.Point(0, 0), new google.maps.Point(-5, 42)),
		...
		map = new Ext.Map({
			...
			listeners: {
				maprender: function(comp, map) {
					var routeKmlLayer = new google.maps.KmlLayer('http://www3.septa.org/transitview/kml/' + curRoute +'.kml');
					routeKmlLayer.setMap(map);
